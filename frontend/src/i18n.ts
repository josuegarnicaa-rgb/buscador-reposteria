...
const textos: Record<Idioma, TextosInterfaz> = {
  ...
  en: {
    navBadge: 'Pastry semantic search',
    navTitle: 'Explore products, recipes, ingredients, tools, and ontology relationships.',
    ...
    languageHelp: 'Searches and results will be shown in the selected language.',
  ...
  pt: {
    navBadge: 'Buscador semântico de confeitaria',
    navTitle: 'Consulte produtos, receitas, ingredientes, ferramentas e relações da ontologia.',
    summaryClases: 'Classes',
    summaryObjectProperties: 'Propriedades de objeto',
    summaryDataProperties: 'Propriedades de dados',
    summaryIndividuos: 'Indivíduos',
    languageLabel: 'Idioma',
    languageHelp: 'A busca e os resultados serão exibidos no idioma escolhido.',
  ...
  fr: {
    navBadge: 'Recherche sémantique de pâtisserie',
    navTitle: 'Consultez les produits, recettes, ingrédients, outils et relations de l’ontologie.',
    summaryClases: 'Classes',
    summaryObjectProperties: "Propriétés d'objet",
    summaryDataProperties: 'Propriétés de données',
    summaryIndividuos: 'Individus',
    languageLabel: 'Langue',
    languageHelp: 'La recherche et les résultats seront affichés dans la langue choisie.',
  ...
  it: {
    navBadge: 'Ricerca semantica di pasticceria',
    navTitle: 'Consulta prodotti, ricette, ingredienti, strumenti e relazioni dell’ontologia.',
    summaryClases: 'Classi',
    summaryObjectProperties: 'Proprietà oggetto',
    summaryDataProperties: 'Proprietà dati',
    summaryIndividuos: 'Individui',
    languageLabel: 'Lingua',
    languageHelp: 'La ricerca e i risultati verranno mostrati nella lingua scelta.',
