...
const textos: Record<Idioma, TextosInterfaz> = {
  ...
  en: {
    ...
    navTitle: 'Consult products, recipes, ingredients, tools, and relationships of the ontology.',
  ...
  pt: {
    ...
    summaryDataProperties: 'Propriedades dos dados',
